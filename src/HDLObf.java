   ...
   private void performConvertAction()
   {
      ...
      try
      {
         switch(jCmb_LOp.getSelectedIndex() )
         {
            ...
            case 1: selectedLanguage = "sv";  break;
            case 2: selectedLanguage = "vhd"; break;
            case 3: selectedLanguage = "sc";  break;
         }
         ...
         {                                                           
            ...
            nc.processFile(selectedLanguage, jText_Map_File.getText(), jText_Source_File.getText(), jText_Target_File.getText());
           
         } 
         else
         { 
            Obfuscate    obf      = new Obfuscate();
            obf.processFile(selectedLanguage, jText_Map_File.getText(), jText_Source_File.getText(), jText_Target_File.getText());
